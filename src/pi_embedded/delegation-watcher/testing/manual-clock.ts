// TEST INFRASTRUCTURE — deterministic virtual clock for watcher timing
// contracts (3s startup delay, 2s poll cadence, idle-end retarget timing,
// 300s stale-claim takeover). No test ever sleeps a real wall interval.
//
// Same semantics as pi_embedded/handoff/testing/manual-clock.ts:
