// pi_platforms/email/clock — structural clock seam shared with the IRC family
// (AutoAdvanceClock). Email poll cycles are driven EXPLICITLY by fixtures, so
// only nowMs/sleepMs/advance shape-compatibility is required.
